...
signal change_page(page) # Signal for changing the page, will be used for state machine implementation
var current_page = "Build" # Default starting page
